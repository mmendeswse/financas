...
const CACHE = "muller-mendes-v156";
const ARQUIVOS = [
  "./", "./index.html", "./css/style.css?v=1.1.3", "./manifest.json", "./manifest.webmanifest",
  "./js/vendor/chart.umd.min.js",
  "./js/bloqueio.js?v=1.1.3", "./js/armazenamento.js?v=1.1.3", "./js/financeiro.js?v=1.1.3", "./js/investimentos.js?v=1.1.3",
  "./js/graficos.js?v=1.1.3", "./js/extrato.js?v=1.1.3", "./js/vendor/pdf.min.js", "./js/vendor/pdf.worker.min.js", "./js/cotacoes.js?v=1.1.3", "./js/sincronizacao.js?v=1.1.3", "./js/app.js?v=1.1.3",
  "./assets/icons/bancos/nubank.svg?v=1.1.3", "./assets/icons/bancos/itau.svg?v=1.1.3", "./assets/icons/bancos/inter.svg?v=1.1.3", "./assets/icons/bancos/banco-do-brasil.svg?v=1.1.3", "./assets/icons/bancos/caixa.svg?v=1.1.3", "./assets/icons/bancos/mercado-pago.svg?v=1.1.3",
