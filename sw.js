...
const ARQUIVOS = [
  ...
  "./js/graficos.js?v=1.0.2", "./js/extrato.js?v=1.0.2", "./js/vendor/pdf.min.js", "./js/vendor/pdf.worker.min.js", "./js/cotacoes.js?v=1.0.2", "./js/sincronizacao.js?v=1.0.2", "./js/app.js?v=1.0.2",
  "./assets/icons/bancos/nubank.svg?v=1.0.2", "./assets/icons/bancos/itau.svg?v=1.0.2", "./assets/icons/bancos/inter.svg?v=1.0.2", "./assets/icons/bancos/banco-do-brasil.svg?v=1.0.2", "./assets/icons/bancos/caixa.svg?v=1.0.2", "./assets/icons/bancos/mercado-pago.svg?v=1.0.2",
