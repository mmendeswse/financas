...
const CACHE = "muller-mendes-v116";
const ARQUIVOS = [
  ...
  "./assets/icons/bancos/nubank.svg?v=1.0.2", "./assets/icons/bancos/itau.svg?v=1.0.2", "./assets/icons/bancos/inter.svg?v=1.0.2", "./assets/icons/bancos/caixa.svg?v=1.0.2", "./assets/icons/bancos/mercado-pago.svg?v=1.0.2",
