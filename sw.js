...
const CACHE = "muller-mendes-v204";
const ARQUIVOS = [
  "./", "./index.html", "./css/style.css?v=1.6.1", "./manifest.json", "./manifest.webmanifest",
  "./js/vendor/chart.umd.min.js",
  "./js/bloqueio.js?v=1.6.1", "./js/armazenamento.js?v=1.6.1", "./js/financeiro.js?v=1.6.1", "./js/investimentos.js?v=1.6.1",
  "./js/graficos.js?v=1.6.1", "./js/extrato.js?v=1.6.1", "./js/vendor/pdf.min.js", "./js/vendor/pdf.worker.min.js", "./js/cotacoes.js?v=1.6.1", "./js/sincronizacao.js?v=1.6.1", "./js/app.js?v=1.6.1",
  "./assets/icons/bancos/nubank.svg?v=1.6.1", "./assets/icons/bancos/itau.svg?v=1.6.1", "./assets/icons/bancos/inter.svg?v=1.6.1", "./assets/icons/bancos/banco-do-brasil.svg?v=1.6.1", "./assets/icons/bancos/caixa.svg?v=1.6.1", "./assets/icons/bancos/mercado-pago.svg?v=1.6.1",
